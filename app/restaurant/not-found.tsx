  ...
  return (
    <div className="h-screen bg-gray-200 flex flex-col justify-center items-center">
      ...
      <div className="bg-white px-9 py-12 shadow rounded">
        ...
        <p className="text-lg font-bold text-center mt-2 text-black">We couldn`t find that restaurant</p>
        <p className="mt-6 text-regular font-light text-center text-black">
          Error Code: 400.
        </p>
      </div>
    </div>
